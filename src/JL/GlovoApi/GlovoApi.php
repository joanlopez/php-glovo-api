...
class GlovoApi
{
    ...
    public function createCustomer($description, $preferredCityCode, $name, $email)
    {
        return $this->customersManager->createCustomer($this->authToken(), $description, $preferredCityCode, $name, $email);
    }
    ...
    public function createOrder($customerUrn, $description, $cityCode, $points, $subtype)
    {
        return $this->ordersManager->createOrder($this->authToken(), $customerUrn, $description, $cityCode, $points, $subtype);
    }
}
